...
var LibraryCreator = {
    start: (blocksJSON, category, text) => {
        ...
        console.log('%c버전 0.1', 'background-color: #007bff; color: #e9ecef; padding: .7rem; font-family: sans-serif; font-size: .9rem; border-radius: 99999rem;')
        console.log('%c매크로블록입니다.', 'font-family: sans-serif; font-size: .7rem')
    }
}
let blockPOST
...
var blocks = [
...

    {
     ...
     func: async (sprite, script) => {
         if (confirm('작품업데이트를 허용하시겠습니까?(악용방지)')){
...
LibraryCreator.start(blocks, 'API', '업데이트') 
document.title = "엔트리";
